...
<div align="center">
  <img src="./src/assets/images/camotea.png" alt="logo" width="140"  height="auto" />
  <br/>
...
# 📖 CamoTea <a name="about-project"></a>
...
<!-- <details>
  ...
  <ul>
    <li><a href="https://expressjs.com/">Heroku</a></li>
  </ul>
</details> -->
...
## 🚀 Live Demo <a name="live-demo">https://camotea.netlify.app/</a>
...
```
  cd my-folder
  git clone https://github.com/vickymarz/camo-tea.git
```
...
I would like to thank Sabastian for the design inspiration, cherrie as the product manager and samuel for building the backend of the application
